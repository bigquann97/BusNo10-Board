...
public class CommentService {
    ...
    @Transactional
    public void editComment(Long postId, Long commentId, CommentRequestDto commentRequestDto, User user) {
        postRepository.findById(postId).orElseThrow(
                () -> new IllegalArgumentException("게시글을 찾을 수 없습니다.")
        );
...
//        }
        Comment comment = commentRepository.findByCommentIdAndUsername(commentId, user.getUsername()).orElseThrow(() -> new IllegalArgumentException("댓글을 찾을 수 없습니다."));
